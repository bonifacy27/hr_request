...
function viewPropertyValuesById(int $elementId, int $propertyId): array
{
    $values = [];
...
$fields = [
    ...
    ['code' => 'STATUS_ADAPTATSII', 'label' => 'Статус адаптации', 'type' => 'VIRTUAL'],
    ...
    ['code' => 'NOMERA_ZAYAVOK_JIRA', 'label' => 'Заявки Jira', 'type' => 'TEXT'],
    ['code' => 'ISTORIYA_ANKETY', 'label' => 'История анкеты', 'type' => 'TEXT'],
];

$sections = [
    ['title' => '1. Основные данные', 'fields' => ['FAMILIYA', 'IMYA', 'OTCHESTVO', 'POL', 'ORGANIZATSIYA', 'DOLZHNOST', 'OTDEL', 'DIREKTSIYA', 'RUKOVODITEL', 'FIO_RUKOVODITELYA', 'OTVETSTVENNYY_MENEDZHER_OPIA', 'STATUS_ADAPTATSII']],
...
$managerName = trim((string)($displayValues['RUKOVODITEL'] ?? ''));
if (trim((string)($displayValues['FIO_RUKOVODITELYA'] ?? '')) === '' && $managerName !== '') {
    $displayValues['FIO_RUKOVODITELYA'] = $managerName;
}
...
<div class="dossier">
    <article class="dossier-shell">
        <header class="dossier-hero">
            <div class="dossier-kicker">Анкета #<?= $anketaId ?></div>
        ...
        <div class="dossier-body">
            ...
            <main class="dossier-main">
                ...
                <details class="dossier-details">
                    <summary>История анкеты</summary>
